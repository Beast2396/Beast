...
(function () {
  ...
  var APPS = [
    ...
    { id: 'projects', icon: 'stack',  title: 'Projects',        w: 560, h: 420, x: 250, y: 130, body: projectsDoc,
      status: function () { return S.projects.length + ' object(s)'; } },
  ...
  DESKTOP.forEach(function (id) {
    if (!byId[id]) throw new Error('Unknown app in DESKTOP: ' + id);
  });
